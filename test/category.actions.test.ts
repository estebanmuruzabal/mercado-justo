...
import { getCategoryById, listCategoriesForAdmin } from '@/server/queries/admin/categories.queries'
import { ROLES } from '@/lib/roles'

vi.mock('@/server/auth/require-staff')
vi.mock('@/lib/supabase/server')
vi.mock('@/server/queries/admin/categories.queries')
vi.mock('next/cache', () => ({
