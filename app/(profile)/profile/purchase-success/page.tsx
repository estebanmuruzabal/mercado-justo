  ...
  if (!user) {
    return (
      <main className='min-h-screen bg-background px-6 py-10'>
        <p className='text-sm text-muted-foreground'>Iniciá sesión para ver el detalle de tu compra.</p>
      </main>
    )
  }
    ...
    return (
      <main className='min-h-screen bg-background px-6 py-10'>
        <div className='mx-auto max-w-3xl space-y-3'>
          ...
          <p className='text-sm text-muted-foreground'>Puede que no esté disponible o no pertenezca a tu cuenta.</p>
        </div>
      </main>
    )
  }
