...
import { PICKUP_HUBS } from '@/domains/marketplace/checkout/domain/checkout/pickup-points.mock'
...
import type { PickupSubOption } from '@/domains/marketplace/checkout/domain/checkout/types'
...
import { getPickupHubById } from '@/domains/marketplace/checkout/domain/checkout/pickup-points.mock'
