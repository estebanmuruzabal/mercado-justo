/** @deprecated Use `@/domains/marketplace/listings/presentation/marketplace/feed/MarketplaceFeedCard` instead. */
'use client'
...
import { ListingCardImage } from '@/shared/ui/listing-card-image'
