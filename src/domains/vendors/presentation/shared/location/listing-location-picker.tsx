...
import { ResistenciaMapPicker } from '@/domains/vendors/presentation/dashboard/vendor-seller/ResistenciaMapPicker'
import { VENDOR_INFORMATION_PATH } from '@/shared/routing/routes'
      ...
      <div className='space-y-1'>
        ...
        {!sellerHasCoords ? (
          <div className='text-sm'>
            <Link href={VENDOR_INFORMATION_PATH} className='text-primary hover:underline'>
