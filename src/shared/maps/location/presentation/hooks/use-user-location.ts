...
import { useUserLocationStore, useUserCoordinates } from '@/shared/maps/location/presentation/stores/useUserLocationStore'
...
export type { Coordinates as UserCoordinates } from '@/shared/maps/location/coordinates'
